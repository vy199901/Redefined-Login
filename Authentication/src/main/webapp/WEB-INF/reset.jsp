										...
										<div class="row mb-3">
											<div class="input-group flex-nowrap">
												<span class="input-group-text" id="addon-wrapping"><i
													...
													class="form-control" placeholder="Enter User-Name" name="userName" id="userName"
													required>
											</div>
										</div>
										<div class="row mb-3">
											<div class="input-group flex-nowrap">
												<span class="input-group-text" id="addon-wrapping"><i
													...
													class="form-control" placeholder="Enter Current Password" name="currentPassword" id="currentPassword"
													maxlength="4" pattern="^[.\S]{4}$" title="Password must be of 4 alpha-numeric characters without space" aria-label="currentPassword" aria-describedby="addon-wrapping"
													required>
											</div>
										</div>
									...
									<form action="" method="POST">
										...
										<div class=" form-group mb-2">
											<input type="text" class="form-control form-control-user"
												maxlength="6" min="6" placeholder="######" id="otp" name="otp"
										...
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-2 font-weight-bold">
												<b>Enter new Password</b>  <img src="looking_eye.gif" width=10% height="10%"/>
											</h1>
										</div>
										<div class=" form-group mb-2">
											<label for="newPassword">New Password:</label>
											<input type="password" class="form-control form-control-user"
												maxlength="4" placeholder="****" id="newPassword" name="newPassword"
												pattern="^[.\S]{4}$"
										...
										<div class=" form-group mb-2">
											...
											<input type="password" class="form-control form-control-user"
												maxlength="4" placeholder="****" id="retypePassword" name="retypePassword"
												pattern="^[.\S]{4}$"
												title="Password must be of 4 alpha-numeric characters"
												style="letter-spacing: 2rem; text-align: center; font-size: large; font-weight: bolder;" />
										</div>
										<div class="text-center">
											<button type="submit" id="btnVerify"
												class="btn btn-primary btn-user btn-block font-weight-bolder text-light">Change Password</button>
										</div>
